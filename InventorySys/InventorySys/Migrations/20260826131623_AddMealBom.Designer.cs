...
namespace InventorySys.Migrations
{
    ...
    [Migration("20260826131623_AddMealBom")]
    partial class AddMealBom
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventorySys.Models.ImportLog", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventorySys.Models.MealIngredient", b =>
                {
                    b.HasOne("InventorySys.Models.Ingredients", null)
                        .WithMany()
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventorySys.Models.Meal", null)
                        .WithMany()
